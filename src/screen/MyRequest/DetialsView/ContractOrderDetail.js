        ...
        >
          ...
          {item?.purchase_order_number ? (
            <OrderViewItem
              ...
              title2={item?.purchase_order_number}
              icon={require('../../../assets/images/order/id.png')}
              title2Style={{
                backgroundColor: '#FFFFFF',
              }}
          ...
          <OrderDateViewItem
            ...
            duration={item?.contract_duration ? item?.contract_duration : '0'}
            styleText={{
          ...
          <OrderViewItem
            ...
            title2={
              item?.date_sign ? moment(item?.date_sign).format('D-MM-Y') : '--'
            }
            icon={require('../../../assets/images/order/date.png')}
            title2Style={{
              backgroundColor: '#FFFFFF',
...
export default memo(ContractOrderDetail);
