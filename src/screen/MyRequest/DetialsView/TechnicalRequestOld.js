          ...
          {false ? (
            ...
            >
              <CommonDropdown
                ...
                placeholderText={
                  state.placeholderClass ? state.placeholderClass : 'التصنيف *'
                }
                disabled={true}
              />
            </View>
          ...
          {false ? (
            ...
            >
              <CommonDropdown
                ...
                placeholderText={
                  state.placeholderTicket ? state.placeholderTicket : 'النوع *'
                }
                disabled={true}
              />
            </View>
          ...
          {false ? (
            ...
            >
              <CommonDropdown
                ...
                onValueChange={(value, index) => handleCategory(value, index)}
          ...
          {false ? (
            ...
            >
              <CommonDropdown
                ...
                onValueChange={(value, index) => handleLocation(value, index)}
            ...
            <View
              style={[
                styles.inputContainer,
                {
                  ...
                  borderRadius: 6,
                  borderColor:
                    state.isValidated && !state.description ? 'red' : '#e3e3e3',
                },
              ]}
            >
              <CommonTextInput
