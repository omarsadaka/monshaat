    ...
    <KeyboardAwareScrollView>
        ...
        <View style={styles.width90}>
          ...
          >
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    state.custody_type === 'permanent' ? '#008AC5' : '#ffffff',
                },
              ]}
              onPress={
                false
            ...
            >
              <Text
                style={[
                  ...
                  {
                    color:
                      state.custody_type === 'permanent' ? '#FCFCFC' : 'gray',
                  },
                ]}
                numberOfLines={1}
              >
            ...
            <TouchableOpacity
              style={[
                ...
                {
                  backgroundColor:
                    state.type === 'temporary' ? '#008AC5' : '#ffffff',
                },
              ]}
              onPress={
                false
            ...
            >
              <Text
                style={[
                  ...
                  // eslint-disable-next-line react-native/no-inline-styles
                  {
                    color: state.type === 'temporary' ? '#FCFCFC' : '#E4E4E4',
                  },
                ]}
                numberOfLines={1}
              >
          ...
          {false ? (
            ...
            <OrderViewItem
              title1="مبلغ العهدة"
              title2={
                item.custody_amount ? item.custody_amount + ' ' + 'ريال' : '--'
              }
              icon={require('../../../assets/images/order/id.png')}
              title2Style={{
                backgroundColor: '#FFFFFF',
          ...
          {false ? (
            ...
            <View>
              <OrderViewItem
                ...
                title2={item.custody_reason ? item.custody_reason : '--'}
                icon={require('../../../assets/images/order/id.png')}
                title2Style={{
                  backgroundColor: '#FFFFFF',
                }}
            ...
            >
              <KeyboardAvoidingView behavior="position" enabled>
                <View style={styles.approveContainer}>
                  <View style={styles.approveNestedContainer}>
                    {item && (
      ...
      <CommonPopup
        ...
        onClose={() => {
          ...
          false ? handleCustody() : approveRequest();
        }}
        onCancel={() => {
          setModal2(false);
        }}
