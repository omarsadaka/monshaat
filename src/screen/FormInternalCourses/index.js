...
const FormInternalCourses = (props) => {
  ...
  useEffect(() => {
    const unsubscribe = props.navigation.addListener('focus', () => {
      ...
      if (props.route.params && props.route.params.item) {
        ...
        let url = `${baseUrl}/api/read/last_update?res_model=hr.training.public&res_id=${item.id}`;
        (async () => {
    ...
    // console.log('newdata', timelineData.length == 0);
    // if (timelineData.length == 0){
    // setState({...state, emptyData: true})
    // }
  });
  ...
  useEffect(async () => {
    ...
    let trainingID = props.route.params.item.id;
            ...
            {state.formData ? (
              <View style={AppStyle.pageBody}>
                ...
                {!editableData && (
                  ...
                  title1="مسمى الدورة"
                    title2={
                      state.formData.training_id
                        ? state.formData.training_id[1]
                        : null
                    }
                    icon={require('../../assets/images/order/category.png')}
                    title2Style={{
                ...
                <OrderViewItem
                  ...
                  title2={state.formData.date_from}
                  icon={require('../../assets/images/order/date.png')}
                  title2Style={{
                    backgroundColor: '#FFFFFF',
                  }}
                />
                <OrderViewItem
                  title1="تاريخ الانتهاء"
                  title2={state.formData.date_to}
                  icon={require('../../assets/images/order/date.png')}
                  title2Style={{
                    backgroundColor: '#FFFFFF',
                  }}
                ...
                <OrderViewItem
                  title1="المدة"
                  title2={state.formData.number_of_days + ' أيام'}
                  icon={require('../../assets/images/order/subject.png')}
                  title2Style={{
                    backgroundColor: '#FFFFFF',
                  }}
                ...
                <OrderViewItem
                  title1="النوع"
                  title2={
                    state.formData.type === 'international' ? 'دولي' : 'محلي'
                  }
                  icon={require('../../assets/images/order/category.png')}
                  title2Style={{
                    backgroundColor: '#FFFFFF',
                ...
                {!editableData &&
                  (state.formData.type === 'regional' ? (
                    <OrderViewItem
                      title1="المدينة"
                      title2={
                        state.formData.place ? state.formData.place[1] : '--'
                      }
                      icon={require('../../assets/images/order/subject.png')}
                      title2Style={{
                        backgroundColor: '#FFFFFF',
                ...
                {!editableData && (
                  <OrderViewItem
                    ...
                    title2={
                      state.formData.programme_training
                        ? state.formData.programme_training
                        : '--'
                    }
                    icon={require('../../assets/images/order/id.png')}
        ...
        >
          ...
          <CommonPopup
            ...
            onClose={() => {
              ...
              editableData ? sendInternalRequest() : approveRequest();
            }}
            onCancel={() => {
              setModal2(false);
            }}
