    ...
    >
      ...
      >
        <KeyboardAwareScrollView>
          <OrderHeader
            {...props}
            title="انتداب"
            icon={require('../../assets/images/mandate.png')}
          />
          <View
            style={{
              padding: '3%',
                ...
                <View style={styles.rowContainer}>
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          state.type === 'external' ? '#008AC5' : '#90909080',
                      },
                    ]}
                    onPress={() =>
                      editableData
                  ...
                  >
                    <Text
                      style={[
                        ...
                        {
                          color:
                            state.type === 'external' ? '#FCFCFC' : '#FFFFFF',
                        },
                      ]}
                    >
                      خارجي
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          state.type === 'internal' ? '#008AC5' : '#90909080',
                      },
                    ]}
                    onPress={() => {
                      if (editableData) {
                  ...
                  >
                    <Text
                      style={[
                        ...
                        {
                          color:
                            state.type === 'internal' ? '#FCFCFC' : '#FFFFFF',
                        },
                      ]}
                    >
                      داخلي
                ...
                <View style={[styles.rowContainer, { marginBottom: 8 }]}>
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          state.transportation_type === 'air_travel'
                            ? '#008AC5'
                            : '#90909080',
                      },
                    ]}
                ...
                {editableData ? (
                  <View
                    style={[
                      ...
                      {
                        borderColor:
                          state.isValidated && !state.deputationSelected
                            ? 'red'
                            : '#e3e3e3',
                        borderRadius: 6,
                        borderWidth: 1,
                  ...
                  >
                    <CommonDropdown
                      itemData={state.allMandateTypesData}
                      onValueChange={(value, index) =>
                        handlemandateTypes(value, index)
                      }
                      value={state.deputationSelected}
                      placeholderText={
                        state.placeholderDeputation
                          ? state.placeholderDeputation
                          : 'نوع الانتداب *'
                      }
                    ...
                    {editableData ? (
                      ...
                      >
                        <CommonTextInput
                          ...
                          changeText={(e) =>
                            setState({ ...state, citySelectedName: e })
                          }
                          value={state.citySelectedName}
      ...
      <CommonPopup
        ...
        onClose={() => {
          ...
          editableData ? handleMandateRequest() : approveRequest();
        }}
        onCancel={() => {
          setModal2(false);
        }}
